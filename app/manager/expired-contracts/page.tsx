        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="bg-white rounded-md shadow-sm mb-6">
            <div className="flex border-b">
              ...
              <Link href="/manager/expired-contracts" className="px-6 py-3 text-sm font-medium text-gray-600 hover:text-gray-900 border-b-2 border-[#005377]">
                Expired Contracts
              </Link>
              ...
              <Link
                ...
                className="px-6 py-3 text-sm font-medium text-gray-900 border-b-2 "
              >
                Add New Listing
              </Link>
            </div>
