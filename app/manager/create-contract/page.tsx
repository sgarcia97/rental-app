        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="bg-white rounded-md shadow-sm mb-6">
            <div className="flex border-b">
              ...
              <Link href="/manager/create-contract" className="px-6 py-3 text-sm font-medium text-gray-600 hover:text-gray-900 border-b-2 border-[#005377]">
                Create New Contract
              </Link>
              <Link
          ...
          <div className="bg-white rounded-md shadow-sm p-6">
            <h2 className="text-lg font-medium text-gray-900 text-center mb-6">New Contract</h2>
